...
### Fixed
- **UI Event Handler Duplication**: Fixed a bug where changing the UI language would cause duplicate event handlers to be bound, leading to potential performance degradation over time.
